...
import { cache, createAsync, RouteDefinition, useNavigate } from '@solidjs/router';
...
export const route = {
  preload({params}) {
    return cache(async () => await fetchBookById(params.id), "book");
  },
} satisfies RouteDefinition;

export default async function Page({ params }: { params: { id: string } }) {
  const book = createAsync(async () => await fetchBookById(params.id));
