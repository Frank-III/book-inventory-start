...
import { createSignal, For, JSX, Show, useTransition } from 'solid-js';
...
export function Sidebar(props: SidebarProps) {
  ...
  const filteredAuthors = () => props.allAuthors
    ? filterAuthors(props.allAuthors, filterText())
    : [];
      ...
      <div class="p-4 border-b">
        ...
        <div class="relative">
          <TextFieldInput
            ...
            class="pl-8"
          />
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width={1.5} stroke="currentColor" class="w-4 h-4 absolute left-2 top-1/2 transform -translate-y-1/2 text-gray-400">
      ...
      <div class="flex-grow">
        <div class="p-4">
          {Object.entries(authorGroups).map(
            ([letter, authors]) =>
              (authors.length > 0 || !props.allAuthors) && (
                <Collapsible >
